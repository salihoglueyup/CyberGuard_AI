    ...
    const getColumns = () => {
        ...
        return Object.keys(tableData[0]).slice(0, 8).map(key => ({
            ...
            render: (val) => {
                ...
                return <span className="text-[var(--hud-text)]">{strVal.length > 50 ? strVal.slice(0, 50) + '...' : strVal}</span>;
            }
        }));
    };
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-xl font-semibold text-[var(--hud-text)] flex items-center gap-3">
                        <Database className="w-6 h-6 text-[var(--hud-cyan)]" />
                        Veritabanı
                    </h1>
                ...
                <Card className="p-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xl font-bold text-[var(--hud-text)]">{tables.length}</p>
                        </div>
                    </div>
                </Card>
                <Card className="p-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xl font-bold text-[var(--hud-text)]">{totalRows.toLocaleString()}</p>
                        </div>
                    </div>
                </Card>
                <Card className="p-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xl font-bold text-[var(--hud-text)]">{dbSize}</p>
                        </div>
                    </div>
                </Card>
                <Card className="p-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <Card className="lg:col-span-1">
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-lg font-semibold text-[var(--hud-text)]">📂 Tablolar</h3>
            ...
            >
                <div className="space-y-4">
                    ...
                    <textarea
                        ...
                        className="w-full h-40 p-4 bg-slate-800 border border-slate-700 rounded-lg text-[var(--hud-text)] font-mono text-sm resize-none focus:outline-none focus:border-blue-500"
