...
export default function AdvancedML() {
    ...
    const renderAutoML = () => (
        <div className="space-y-6">
            ...
            <div className="card p-6">
                <h3 className="text-lg font-semibold text-[var(--hud-text)] mb-4">AutoML Konfigürasyonu</h3>
            ...
            {automlStatus && (
                <div className="card p-6">
                    <h3 className="text-lg font-semibold text-[var(--hud-text)] mb-4">AutoML Durumu</h3>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="text-center">
                            <div className="text-3xl font-bold text-[var(--hud-cyan)]">{automlStatus.completed_trials || 0}</div>
    ...
    const renderXAI = () => (
        <div className="space-y-6">
            {/* Model Selector */}
            <div className="card p-6">
                <h3 className="text-lg font-semibold text-[var(--hud-text)] mb-4">Model Seçimi</h3>
                <select
            ...
            {featureImportance && (
                <div className="card p-6">
                    <h3 className="text-lg font-semibold text-[var(--hud-text)] mb-4">Feature Importance</h3>
    ...
    const renderABTesting = () => (
        <div className="space-y-6">
            <div className="card p-6">
                <h3 className="text-lg font-semibold text-[var(--hud-text)] mb-4">A/B Test Oluştur</h3>
            ...
            <div className="card p-6">
                <h3 className="text-lg font-semibold text-[var(--hud-text)] mb-4">Aktif Testler</h3>
                {abTests.length === 0 ? (
                    ...
                    <div className="space-y-3">
                        {abTests.map((test, idx) => (
                            <div key={idx} className="p-4 bg-slate-800 rounded-lg flex justify-between items-center">
                                <div>
                                    <div className="font-medium text-[var(--hud-text)]">{test.name}</div>
                                    <div className="text-sm text-slate-400">
        ...
        <div className="space-y-6">
            {driftStatus && (
                <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className={`card p-6 border-2 ${driftStatus.has_drift ? 'border-red-500' : 'border-green-500'
                            ...
                            <div className="text-center">
                                ...
                                <div className="text-lg font-semibold text-[var(--hud-text)]">
                        ...
                        <div className="card p-6">
                            <div className="text-center">
                                <div className="text-3xl font-bold text-[var(--hud-cyan)]">
                    ...
                    {/* Severity */}
                    <div className="card p-6">
                        <h3 className="text-lg font-semibold text-[var(--hud-text)] mb-4">Drift Seviyesi</h3>
            ...
            {flStatus && (
                <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div className="card p-6 text-center">
                            <div className="text-3xl font-bold text-[var(--hud-cyan)]">{flStatus.current_round || 0}</div>
    ...
    return (
        <div className="p-6">
            {/* Header */}
            <div className="mb-6">
                <h1 className="text-xl font-semibold text-[var(--hud-text)]">Advanced ML</h1>
                <p className="text-[var(--hud-text-muted)] text-xs tracking-wide mt-1">AutoML, Explainability, A/B Testing, Drift Detection, Federated Learning</p>
            </div>
            ...
            {loading ? (
                <div className="flex justify-center py-12">
                    <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[var(--hud-cyan)]"></div>
                </div>
            ) : (
                <>
