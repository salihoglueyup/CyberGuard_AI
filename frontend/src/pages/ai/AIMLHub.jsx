...
export default function AIMLHub() {
    ...
    const loadAnalyticsData = async () => {
        try {
            const [sysRes, perfRes] = await Promise.allSettled([
                dashboardApi.getStats(),
                modelsApi.getStats(),
            ]);
            if (sysRes.status === 'fulfilled' && sysRes.value.data?.success) setSystemMetrics(sysRes.value.data.data);
            if (perfRes.status === 'fulfilled' && perfRes.value.data?.success) setModelPerformance(perfRes.value.data.data);
        } catch (err) {
    ...
    const handleInitialize = async () => {
        ...
        try {
            ...
            toast.success('AI Engine initialization started!');
            ...
            <div className="card p-4">
                ...
                <div className="grid grid-cols-5 gap-4">
                    {[
                        ...
                        <div key={i} className="text-center p-3 bg-[var(--hud-surface)]/50 rounded-lg">
                            <div className={`text-2xl mb-1 ${comp.active ? 'text-green-400' : 'text-[var(--hud-amber)]'}`}>
                                {comp.active ? '✅' : '⏳'}
                            </div>
                            <div className="text-xs text-[var(--hud-text-muted)]">{comp.name}</div>
                        </div>
                    ))}
                </div>
            </div>
                    ...
                    <div key={type} className="card p-4 hover:border-blue-500/50 transition-all">
                        <div className="flex items-center gap-3 mb-3">
                            ...
                            <div>
                                ...
                                <span className="text-xs text-[var(--hud-text-muted)]">IDS Model</span>
                            </div>
                        </div>
            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                <div className="card p-4">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Model Type</label>
                ...
                <div className="card p-4">
                    ...
                    {trainings.length === 0 ? (
                        <div className="text-center py-8 text-[var(--hud-text-muted)]">
                            No active trainings
                        </div>
                    ) : (
                        <div className="space-y-2">
                            {trainings.map((t, i) => (
                                <div key={i} className="p-3 bg-[var(--hud-surface)]/50 rounded-lg flex justify-between">
        ...
        <div className="space-y-6">
                ...
                <div className="grid grid-cols-4 gap-4">
                    {['Engine', 'Zero-Day', 'Meta', 'RL'].map((name, i) => (
                        <div key={i} className="text-center p-3 bg-[var(--hud-surface)]/50 rounded-lg">
                            ...
                            <div className="text-xs text-[var(--hud-text-muted)]">{name}</div>
                        </div>
                    ))}
                </div>
            </div>
            ...
            <div className="card p-4 border-red-500/30">
                ...
                <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="p-3 bg-[var(--hud-surface)]/50 rounded-lg">
                        <div className="text-sm text-[var(--hud-text-muted)]">β Value</div>
            ...
            <div className="card p-4 border-green-500/30">
                ...
                <div className="grid grid-cols-3 gap-4">
                    <div className="p-3 bg-[var(--hud-surface)]/50 rounded-lg">
                        <div className="text-sm text-[var(--hud-text-muted)]">Algorithm</div>
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                <div className="card p-4">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">β Value</label>
                            <input
                        ...
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Latent Dimension</label>
                            <select
                        ...
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Sensitivity (1-5)</label>
                            <input
                ...
                <div className="card p-4">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Algorithm</label>
                            <select
                                className="input-field w-full"
                        ...
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Epsilon</label>
                            <input
                        ...
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Gamma</label>
                            <input
                ...
                <div className="card p-4">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">SHAP Samples</label>
                            <input
                        ...
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Top Features</label>
                            <input
                ...
                {/* Alert Settings */}
                <div className="card p-4">
                    <h3 className="text-lg font-semibold mb-4 text-[var(--hud-amber)]">🟡 Alerts</h3>
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            <span className="text-sm text-[var(--hud-text-muted)]">Auto Alert</span>
                            <button
                                className={`w-12 h-6 rounded-full transition-colors ${settings.alerts.auto_alert ? 'bg-green-500' : 'bg-[var(--hud-border)]'}`}
                        ...
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Threshold</label>
                            <input
                                ...
                                className="w-full"
                            />
                            <span className="text-sm text-[var(--hud-amber)]">{settings.alerts.threshold}</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                <div className="card p-4">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Attack Type</label>
                            <select
                                className="input-field w-full"
                        ...
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Confidence</label>
                            <input
                ...
                <div className="card p-4">
                    ...
                    {explanation ? (
                        <div className="space-y-3">
                            <div className="text-sm text-[var(--hud-text-muted)]">Top Features:</div>
                            {explanation.top_features?.map((f, i) => (
                                <div key={i} className="flex justify-between p-2 bg-[var(--hud-surface)]/50 rounded">
                                    <span>{f.feature}</span>
                                    <span className={f.importance > 0 ? 'text-green-400' : 'text-red-400'}>
                                        {f.importance?.toFixed(4)}
                                    </span>
                                </div>
                            )) || <div className="text-[var(--hud-text-dim)]">No features available</div>}
                        </div>
                    ) : (
                        <div className="text-center py-8 text-[var(--hud-text-muted)]">
            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                <div className="card p-4">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Template</label>
                            <select className="input-field w-full">
                        ...
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Language</label>
                            <select className="input-field w-full">
                ...
                <div className="card p-4">
                    ...
                    {generatedReport ? (
                        <div className="prose prose-invert max-w-none">
                            <pre className="whitespace-pre-wrap text-sm bg-[var(--hud-surface)]/50 p-4 rounded-lg">
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                <div className="card p-4">
                    ...
                    <div className="space-y-4">
                        <div className="p-3 bg-[var(--hud-surface)]/50 rounded-lg">
                            <div className="text-sm text-[var(--hud-text-muted)]">Prediction</div>
                            <div className="text-xl font-bold text-green-400">Normal (95.2%)</div>
                        </div>
                        <div className="p-3 bg-[var(--hud-surface)]/50 rounded-lg">
                            <div className="text-sm text-[var(--hud-text-muted)]">Zero-Day</div>
                            <div className="text-xl font-bold text-blue-400">Not Detected</div>
                        </div>
                        <div className="p-3 bg-[var(--hud-surface)]/50 rounded-lg">
                            <div className="text-sm text-[var(--hud-text-muted)]">RL Decision</div>
                            <div className="text-xl font-bold text-[var(--hud-amber)]">IGNORE</div>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        {[
                            ...
                            <div key={i}>
                                <div className="flex justify-between text-sm mb-1">
                                    <span className="text-[var(--hud-text-muted)]">{r.label}</span>
                                    <span>{r.value.toFixed(1)}%</span>
                                </div>
                                <div className="w-full h-2 bg-[var(--hud-panel)] rounded">
                                    <div
        ...
        <div className="space-y-6">
            ...
            <div className="card p-4">
                ...
                <div className="grid grid-cols-6 gap-3">
                    {MODEL_TYPES.map((type) => (
                        <label key={type} className="flex items-center gap-2 p-2 bg-[var(--hud-surface)]/50 rounded-lg cursor-pointer hover:bg-[var(--hud-panel)]/50">
                ...
                {models.length > 0 ? (
                    <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                            ...
                            <tbody>
                                {models.map((m, i) => (
                                    <tr key={i} className="border-b border-[var(--hud-surface)] hover:bg-[var(--hud-surface)]/30">
                                        ...
                                        <td className="p-2 text-right text-[var(--hud-amber)]">
                                            {m.recall?.toFixed(2) || 'N/A'}
                                        </td>
                                        <td className="p-2 text-right text-[var(--hud-text-muted)]">
            ...
            <div className="card p-4">
                ...
                <div className="h-64 flex items-center justify-center bg-[var(--hud-surface)]/30 rounded-lg">
                    <div className="text-center text-[var(--hud-text-muted)]">
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                <div className="card p-4">
                    ...
                    <div className="space-y-3">
                        {MODEL_TYPES.filter(t => t !== 'ensemble').map((type) => (
                            <div key={type} className="flex items-center justify-between p-3 bg-[var(--hud-surface)]/50 rounded-lg">
                                <label className="flex items-center gap-3">
                                    <input type="checkbox" className="w-4 h-4" defaultChecked />
                                    <span className="uppercase font-medium">{type}</span>
                                </label>
                                <div className="flex items-center gap-2">
                                    <span className="text-sm text-[var(--hud-text-muted)]">Weight:</span>
                                    <input
                ...
                <div className="card p-4">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Voting Strategy</label>
                            <select className="input-field w-full">
                        ...
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Meta Learner</label>
                            <select className="input-field w-full">
                        ...
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Confidence Threshold</label>
            ...
            <div className="card p-4">
                ...
                <div className="grid grid-cols-3 gap-4">
                    {[
                        ...
                        <div key={i} className="p-4 bg-[var(--hud-surface)]/50 rounded-lg">
                            <h4 className="font-semibold">{e.name}</h4>
                            <div className="text-sm text-[var(--hud-text-muted)] mt-1">{e.models} models</div>
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-6">
                ...
                <div className="card p-4">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Search Space</label>
                            <select className="input-field w-full">
                        ...
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Time Budget (minutes)</label>
                            <input type="number" className="input-field w-full" defaultValue={30} />
                        </div>
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Optimization Metric</label>
                            <select className="input-field w-full">
                ...
                <div className="card p-4">
                    <h3 className="text-lg font-semibold mb-4 flex items-center gap-2">
                        <TrendingUp className="text-[var(--hud-amber)]" size={20} />
                        Model Drift Detection
                    </h3>
                    <div className="space-y-4">
                        <div className="p-3 bg-[var(--hud-surface)]/50 rounded-lg">
                            <div className="flex justify-between items-center">
                                <span className="text-[var(--hud-text-muted)]">Data Drift</span>
                                <span className="text-green-400 font-bold">Low (0.02)</span>
                            </div>
                            <div className="w-full h-2 bg-[var(--hud-panel)] rounded mt-2">
                                <div className="h-full w-[8%] bg-green-500 rounded" />
                            </div>
                        </div>
                        <div className="p-3 bg-[var(--hud-surface)]/50 rounded-lg">
                            <div className="flex justify-between items-center">
                                <span className="text-[var(--hud-text-muted)]">Concept Drift</span>
                                <span className="text-[var(--hud-amber)] font-bold">Medium (0.15)</span>
                            </div>
                            <div className="w-full h-2 bg-[var(--hud-panel)] rounded mt-2">
                        ...
                        <div className="p-3 bg-[var(--hud-surface)]/50 rounded-lg">
                            <div className="flex justify-between items-center">
                                <span className="text-[var(--hud-text-muted)]">Performance Drift</span>
                ...
                <div className="card p-4">
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Model A</label>
                                <select className="input-field w-full">
                                    {MODEL_TYPES.map(t => <option key={t} value={t}>{t.toUpperCase()}</option>)}
                                </select>
                            </div>
                            <div>
                                <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Model B</label>
                        ...
                        <div>
                            <label className="block text-sm text-[var(--hud-text-muted)] mb-1">Traffic Split</label>
                            <input type="range" min="10" max="90" defaultValue="50" className="w-full" />
                            <div className="flex justify-between text-xs text-[var(--hud-text-muted)]">
                                <span>A: 50%</span>
                                <span>B: 50%</span>
                            </div>
                        </div>
                    ...
                    <div className="space-y-4">
                        <div className="p-3 bg-[var(--hud-surface)]/50 rounded-lg">
                            <div className="flex justify-between">
                                <span className="text-[var(--hud-text-muted)]">Connected Nodes</span>
                                <span className="text-green-400 font-bold">5 / 8</span>
                            </div>
                        </div>
                        <div className="p-3 bg-[var(--hud-surface)]/50 rounded-lg">
                            <div className="flex justify-between">
                                <span className="text-[var(--hud-text-muted)]">Global Rounds</span>
                                <span className="text-blue-400 font-bold">12</span>
                            </div>
                        </div>
                        <div className="p-3 bg-[var(--hud-surface)]/50 rounded-lg">
                            <div className="flex justify-between">
                                <span className="text-[var(--hud-text-muted)]">Aggregation</span>
        ...
        <div className="relative min-h-screen bg-[var(--hud-bg)] text-[var(--hud-text)] p-6">
            ...
            <div className="mb-6">
                <h1 className="text-xl font-semibold flex items-center gap-3 text-[var(--hud-text)]">
                    ...
                    AI/ML Hub
                    <span className="text-[10px] font-normal text-[var(--hud-text-muted)] ml-2 tracking-wide">
            ...
            {/* Tabs */}
            <div className="flex flex-wrap gap-2 mb-6 border-b border-[var(--hud-border)] pb-4">
                {TABS.map(tab => (
                    <button
                        key={tab.id}
...
function StatCard({ title, value, subtitle, color }) {
    ...
    return (
        <div className={`card p-4 ${colors[color]}`}>
            <div className="text-sm text-[var(--hud-text-muted)]">{title}</div>
            <div className="text-2xl font-bold mt-1">{value}</div>
            {subtitle && <div className="text-xs text-[var(--hud-text-dim)]">{subtitle}</div>}
        </div>
    );
}
