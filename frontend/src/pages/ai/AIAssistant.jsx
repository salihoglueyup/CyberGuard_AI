    ...
    return (
        <div className="h-[calc(100vh-6rem)] flex flex-col fade-in">
            ...
            <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 to-blue-600 flex items-center justify-center">
                        <Brain className="w-7 h-7 text-[var(--hud-text)]" />
                    </div>
                    <div>
                        <h1 className="text-2xl font-bold text-[var(--hud-text)]">AI Assistant</h1>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2 bg-slate-800/50 rounded-xl px-3 py-2 border border-slate-700">
                        ...
                        <select
                            ...
                            className="bg-transparent border-none text-[var(--hud-text)] text-sm focus:outline-none cursor-pointer"
                        >
                            {providers.map((p) => (
                                <option
                                    key={p.id}
                ...
                <div className="mb-4 p-3 bg-gradient-to-r from-purple-900/20 to-blue-900/20 rounded-xl border border-purple-500/20">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <span className="text-[var(--hud-text)] font-medium">{selectedModelInfo.name}</span>
                        ...
                        <button
                            ...
                            className="flex items-center gap-1 text-xs text-slate-400 hover:text-[var(--hud-text)] transition-colors"
                        >
                            Hızlı Aksiyonlar
            ...
            <div className="flex-1 overflow-y-auto bg-slate-900/50 rounded-xl p-4 space-y-4">
                {messages.length === 0 && (
                    <div className="text-center py-12">
                        ...
                        <h3 className="text-xl font-semibold text-[var(--hud-text)] mb-2">CyberGuard AI Assistant</h3>
                ...
                {messages.map((msg, idx) => (
                    <div key={idx} className={`flex gap-3 ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                        ...
                        <div className={`max-w-[75%] px-4 py-3 rounded-2xl ${msg.role === 'user'
                            ? 'bg-gradient-to-r from-blue-600 to-blue-700 text-[var(--hud-text)]'
            ...
            <div className="mt-4 flex gap-3">
                <div className="flex-1 relative">
                    <input
                        ...
                        className="w-full px-5 py-4 bg-slate-800 border border-slate-700 rounded-xl 
                                   text-[var(--hud-text)] placeholder-slate-500 focus:outline-none focus:border-purple-500 
                ...
                >
                    <Send className="w-5 h-5 text-[var(--hud-text)]" />
                </button>
            </div>
        </div>
    );
