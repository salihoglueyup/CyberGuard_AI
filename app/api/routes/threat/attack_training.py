...
async def run_attack_specific_training(
    ...
    try:
        ...
        # Dataset yükle
        import numpy as np
        from scripts.train_ssa_lstmids import load_bot_iot, load_nsl_kdd, prepare_data
        ...
        if request.use_smote:
            ...
            try:
                ...
                print(f"[attack_training] SMOTE resampling failed: {e}")
    ...
    for model_file in MODELS_DIR.glob("*.h5"):
        ...
        if params_file.exists():
            try:
                ...
                print(f"[attack_training] Failed to load model params: {e}")
