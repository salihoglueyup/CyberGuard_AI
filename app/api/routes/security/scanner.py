...
async def upload_file(file: UploadFile = File(...)):
    ...
    try:
        ...
        try:
            ...
            logger.warning(f"Scan result DB save failed: {e}")
        ...
        try:
            ...
            logger.warning(f"Tarama sonrası dosya silinemedi: {e}")
...
async def get_scan_results(limit: int = 20):
    ...
    try:
        ...
        logger.warning(f"Scan history retrieval failed: {e}")
...
async def get_scanner_stats():
    ...
    try:
        ...
        logger.warning(f"Scanner stats retrieval failed: {e}")
        return {
            "success": True,
            "data": {
                "total_scans": 0,
