...
Large Language Model tabanlı IDS raporlama modülü.
...
""",
    "quick_alert": """
🔔 **{severity} Alert:** {attack_type} detected
📍 Target: {target_info}
