...
class DatabaseManager:
    ...
    def get_connection(self):
        ...
        try:
            ...
            print(f"⚠️ SQLite bağlantı hatası: {e}")
            # Boş bir mock connection döndür
            raise
        finally:
            if conn:
                conn.close()
    ...
    def get_attacks(
        ...
        Args:
            hours (int): Kaç saat geriye bakılacak (None = tüm zamanlar)
            attack_type (str): Saldırı tipi filtresi
